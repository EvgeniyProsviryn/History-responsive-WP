...
function ale_enqueue_styles() {
	...
	wp_register_style( 'aletheme_general_css', THEME_URL . '/css/main.css', array(), ALETHEME_THEME_VERSION, 'all');
	wp_register_style( 'animate_css', THEME_URL . '/css/Animate.css', array(), ALETHEME_THEME_VERSION, 'all');
	wp_register_style( 'bootstrap_grid_min_css', THEME_URL . '/css/bootstrap-grid.min.css', array(), ALETHEME_THEME_VERSION, 'all');
	wp_register_style( 'fonts_css', THEME_URL . '/css/fonts.css', array(), ALETHEME_THEME_VERSION, 'all');
	wp_register_style( 'media_css', THEME_URL . '/css/media.css', array(), ALETHEME_THEME_VERSION, 'all');

	wp_enqueue_style('animate_css');
	wp_enqueue_style('bootstrap_grid_min_css');
...
function ale_enqueue_scripts() {
    ...
    wp_register_script( 'parallax_min_js', THEME_URL . '/js/libs/parallax.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'common_js', THEME_URL . '/js/libs/common.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'validation_js', THEME_URL . '/js/libs/jqBootstrapValidation.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );

    wp_enqueue_script( 'parallax_min_js' );
