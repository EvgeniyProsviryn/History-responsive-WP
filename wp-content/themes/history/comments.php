                    ...
                    <div id="show-hide">
                                    ...
                                    <div class="continer">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="message-submit col-md-12 col-sm-12 col-xs-12">

                                                    <textarea name="comment" placeholder="<?php _e('Say Something', 'aletheme'); ?> *" id="comment" class="message col-md-12 col-sm-12 col-xs-12" required="required"></textarea>
                                                    <input name="submit" class="submit send" type="submit" value="<?php _e('SUBMIT', 'aletheme'); ?>" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <?php if (comments_open()) : ?>
                            ...
                            <?php if (have_comments()) : ?>
                                <div class="col-md-12 over"><?php wp_list_comments(array('callback' => 'aletheme_comment_default','style' => 'div', 'max_depth' => 2,'avatar_size' => 52,)); ?></div>
